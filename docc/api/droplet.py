...
def droplets(credentials):
    ...
    for encoded_droplet in encoded_droplets:
        size = docc.api.size.get(credentials,encoded_droplet['size_id'])
        image = docc.api.image.get(credentials,encoded_droplet['image_id'])
        region = docc.api.region.get(credentials,encoded_droplet['region_id'])
